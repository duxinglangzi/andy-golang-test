...
func getDiskInfo() {
	...
	for _, part := range parts {
		...
		fmt.Printf("disk info:used:%v free:%v , toString:%v \n", diskInfo.UsedPercent, diskInfo.Free,diskInfo.String())
	}
